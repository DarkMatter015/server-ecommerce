...
-- USUÁRIOS
-- ==================================================================================
INSERT INTO tb_user(display_name, email, password, cpf) VALUES ('Administrador', 'admin@teste.com','$2a$10$LOqePml/koRGsk2YAIOFI.1YNKZg7EsQ5BAIuYP1nWOyYRl21dlne', '12345678910');
INSERT INTO tb_user(display_name, email, password, cpf) VALUES ('Teste', 'test@teste.com','$2a$10$LOqePml/koRGsk2YAIOFI.1YNKZg7EsQ5BAIuYP1nWOyYRl21dlne', '10987654321');
...
-- ORDER STATUS
-- ==================================================================================
insert into tb_order_status(name) values ('PENDENTE');
insert into tb_order_status(name) values ('PROCESSANDO');
insert into tb_order_status(name) values ('ENVIADO');
insert into tb_order_status(name) values ('ENTREGUE');
insert into tb_order_status(name) values ('CANCELADO');
