package br.edu.utfpr.pb.ecommerce.server_ecommerce.infra.rabbitmq.consumer.mail;
...
public class EmailConsumer {
    ...
    public void consumeEmailMessage(String message) throws JsonProcessingException {
        ...
        try {
            log.info("Processing send email verification: {}", emailEventDTO.email());
            ...
            log.info("Reset email successfully sent to: {}", emailEventDTO.email());
        } catch (Exception e) {
